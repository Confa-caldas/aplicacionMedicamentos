...
export const environment = {
  ...
  identificacionSas:
    'https://sasweb.confa.co:8322/medicamentosWS/rest/medicamentos/', //ruta apuntando al DMZSAS
  //identificacionSas:
  //'https://sasweb.confa.co:8586/medicamentosWS/rest/medicamentos/', // producción
